...
const DashboardView = ({ user, items, is_loading, searchTerm, setSearchTerm, setShowModal, selectedTasks, setSelectedTasks, handleBulkDelete, openEditModal, activeTaskId, setActiveTaskId, filteredTasks }) => {
