...
import axios from 'axios'; // Or use your redux action if you have one
...
const ForgotPasswordPage = () => {
  ...
  const handle_submit = async (e) => {
    ...
    try {
      // Replace with your actual backend URL or Redux dispatch
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl">
        ...
        <p className="text-gray-600 text-center mb-8">Enter your email and we'll send you a link to get back into your account.</p>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Suddenly remembered? <Link to="/login" className="text-blue-600 font-medium hover:underline">Back to Login</Link>
        </p>
      </div>
    </div>
  );
