...
const sendEmails = require ('../utils/send_email.js');
...
const forgotPassword = async (request, response) => {
    ...
    try {
        ...
        // Saving user with tokens
        await user.save();

        // Reset url
        const resetUrl = `http://localhost:5173/reset-password/${token}`;
        const message = `We received a request to reset your password. Please click the link below to proceed:\n\n${resetUrl}\n\nThis link will expire in 10 minutes. If you didn't request this, please ignore this email.`;
